...
public class PointCalculator implements Runnable {
  ...
  public PointCalculator(int xMax, int xMin, double startX, double startY, double[][] x,
      double[][] y, int curveIndex, double stepLength, DoubleBinaryOperator f) {
    this.xMax = xMax;
    this.xMin = xMin;
    this.startX = startX;
    this.startY = startY;
  ...
  public void producePoints(double startX, double startY, int curveIndex, double stepLength,
