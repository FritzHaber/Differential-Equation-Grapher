...
public class GraphFX {
  ...
  // TODO: scale point density based on zoom, roughly 10:1, so for zoom = 2x, should have a point
  // res of 20, or a bit less
  ...
  public void draw() {
    ...
    for (int i = 0; i < lines.size() / zoomLevel; i++) {
      drawLine(lines.get((int) (i * zoomLevel)));
    }
  }
